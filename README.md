...
A cybersecurity and penetration testing lab setup
CYBERSECURITY LAB SETUP
Building a controlled environment for penetration testing and ethical hacking.
...
It uses a private network which would be used subsequently with other machines to carry out specific tasks.
...
Step 1. Install 7zip
7zip was installed to extract the kali-linux package which was distributed as 7zip archive.

Step 2. Install virtual box
The virtual box was install as the hypervisor.
